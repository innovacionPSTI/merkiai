...
"[project]/packages/database/src/lib/stock.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/database/src/lib/bold-reconcile.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$lib$2f$stock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/database/src/lib/stock.ts [app-route] (ecmascript)");
;
;
;
;
async function reconcileBoldOrder(orderNumber) {
    ...
    const config = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$queries$2f$payment$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPaymentConfig"])().catch(()=>null);
    if (!config?.bold_api_key) return {
        ok: false,
        reason: 'not_configured'
    };
    const gateway = new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$providers$2f$payment$2f$BoldGateway$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BoldGateway"]({
    ...
    if (paymentStatus === 'approved') {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$lib$2f$stock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applyStockForOrder"])(orderNumber);
    }
    return {
        ok: true,
        status: paymentStatus
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$lib$2f$stock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/database/src/lib/stock.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$lib$2f$bold$2d$reconcile$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/database/src/lib/bold-reconcile.ts [app-route] (ecmascript)");
...
"[project]/apps/web/src/lib/email.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
function baseTemplate(content, config) {
    const name = config.storeName ?? 'Mi Tienda';
    const url = (config.siteUrl ?? ("TURBOPACK compile-time value", "https://vps-coffee.com") ?? '').replace(/\/$/, '');
    return `<!DOCTYPE html>
<html lang="es">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"></head>
<body style="margin: 0; padding: 0; background-color: #fff8ec;">
...
function buildEmailConfig(apiKey, fromEmail, storeName, emailProvider) {
    return {
        apiKey,
        fromEmail,
        storeName: storeName ?? undefined,
        siteUrl: ("TURBOPACK compile-time value", "https://vps-coffee.com"),
...
async function sendNewsletterConfirmation(to, config) {
    const name = config.storeName ?? 'Mi Tienda';
    const siteUrl = (config.siteUrl ?? ("TURBOPACK compile-time value", "https://vps-coffee.com") ?? '').replace(/\/$/, '');
    const content = `
...
async function sendWelcomeEmail(to, name, config) {
...
"[project]/apps/web/src/lib/shipping/shipments.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
async function createShipmentForOrder(orderNumber) {
    try {
        const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createServerClient"])();
        // 1. Load the order
        ...
        const config = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$queries$2f$shipping$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getShippingConfig"])();
        ...
        if (!skydropx_client_id || !skydropx_client_secret || !origin_name || !origin_street || !origin_city || !origin_department || !origin_postal_code || !origin_phone || !origin_email) {
        ...
        const parcel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$shipping$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["calculateParcel"])(items.map((i)=>({
                weight: i.variant_label ?? '500g',
                qty: i.qty
            })));
        // 5. Create the shipment via Skydropx
        const provider = new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$shipping$2f$providers$2f$skydropx$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SkydropxProvider"]({
...
"[project]/apps/web/src/lib/bold-reconcile.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$providers$2f$payment$2f$BoldGateway$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/database/src/providers/payment/BoldGateway.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$lib$2f$stock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/database/src/lib/stock.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/apps/web/src/lib/email.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$shipping$2f$shipments$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/shipping/shipments.ts [app-route] (ecmascript)");
;
;
;
async function reconcileBoldOrder(orderNumber) {
    ...
    const { data: updatedOrder, error } = await supabase.from('orders').update(updatePayload).eq('order_number', orderNumber).select().single();
    ...
    if (paymentStatus === 'approved') {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$lib$2f$stock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applyStockForOrder"])(orderNumber);
        const storeConfig = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$queries$2f$store$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStoreConfig"])().catch(()=>null);
        const emailConfig = storeConfig?.resend_api_key && storeConfig?.resend_from_email ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["buildEmailConfig"])(storeConfig.resend_api_key, storeConfig.resend_from_email, storeConfig.store_name, storeConfig.email_provider) : null;
        if (emailConfig) {
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["sendOrderConfirmation"])(updatedOrder, emailConfig);
            } catch (err) {
                console.error('[bold-reconcile] Error email confirmación:', err);
            }
        }
        const shipment = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$shipping$2f$shipments$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createShipmentForOrder"])(orderNumber);
        if (shipment && emailConfig) {
            const { data: shippedOrder } = await supabase.from('orders').select('*').eq('order_number', orderNumber).single();
            if (shippedOrder?.tracking_number) {
                try {
                    const { sendShippingNotification } = await __turbopack_context__.A("[project]/apps/web/src/lib/email.ts [app-route] (ecmascript, async loader)");
                    await sendShippingNotification(shippedOrder, emailConfig);
                } catch (err) {
...
"[project]/apps/web/src/app/api/checkout/bold/reconcile/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$bold$2d$reconcile$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/bold-reconcile.ts [app-route] (ecmascript)");
;
;
/**
...
async function POST(req) {
    ...
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$bold$2d$reconcile$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reconcileBoldOrder"])(order);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__16b2pp2._.js.map