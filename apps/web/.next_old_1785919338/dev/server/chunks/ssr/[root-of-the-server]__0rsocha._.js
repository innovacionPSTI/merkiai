...
"[project]/packages/database/src/queries/banners.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/database/src/client.ts [app-rsc] (ecmascript)");
;
async function getBanners(section) {
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createServerClient"])();
    const { data, error } = await supabase.from('banners').select('*').eq('section', section).eq('active', true).order('order_index', {
        ascending: true
    });
    if (error) throw error;
    return data;
...
async function getHomeBanners() {
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createServerClient"])();
    // Intentar banners del home (post-migración 14)
    const { data: homeData, error: homeError } = await supabase.from('banners').select('*').is('page_key', null).eq('active', true).order('order_index', {
        ascending: true
    });
    if (homeError) throw homeError;
    // Si existen banners sin page_key, usarlos directamente
    if (homeData && homeData.length > 0) return homeData;
    // Fallback: banners de section='hero' (compatibilidad con datos pre-migración 14)
    const { data: heroData, error: heroError } = await supabase.from('banners').select('*').eq('section', 'hero').eq('active', true).order('order_index', {
        ascending: true
    });
...
"[project]/packages/database/src/queries/testimonials.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/database/src/client.ts [app-rsc] (ecmascript)");
;
async function getTestimonials(onlyActive = true, pageKey) {
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createServerClient"])();
    ...
    if (pageKey !== undefined) {
        query = query.or(`page_key.eq.${pageKey},page_key.is.null`);
    }
    const { data, error } = await query;
    if (error) throw error;
    return data;
...
"[project]/packages/database/src/queries/sections.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/database/src/client.ts [app-rsc] (ecmascript)");
;
async function getSectionSettings(pageKey = 'home') {
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createServerClient"])();
    const { data, error } = await supabase.from('section_settings').select('key, page_key, label, description, enabled, order_index').eq('page_key', pageKey).order('order_index');
    if (error) throw error;
    return data ?? [];
}
async function isSectionEnabled(key, pageKey = 'home') {
    try {
        const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createServerClient"])();
        const { data } = await supabase.from('section_settings').select('enabled').eq('key', key).eq('page_key', pageKey).maybeSingle();
...
async function getHomeData() {
    ...
    const [sectionsRes, bannersRes] = await Promise.all([
        supabase.from('section_settings').select('*').eq('page_key', 'home').order('order_index'),
        supabase.from('banners').select('*').is('page_key', null) // banners globales del home
        .order('order_index')
    ]);
...
async function updateSectionItem(id, input) {
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createServerClient"])();
    const { data, error } = await supabase.from('section_items').update(input).eq('id', id).select().single();
    if (error) throw error;
    return data;
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$queries$2f$blog$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/database/src/queries/blog.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$queries$2f$banners$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/database/src/queries/banners.ts [app-rsc] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$queries$2f$testimonials$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/database/src/queries/testimonials.ts [app-rsc] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$queries$2f$sections$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/database/src/queries/sections.ts [app-rsc] (ecmascript)");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0rsocha._.js.map