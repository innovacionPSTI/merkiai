...
async function POST(req) {
    ...
    try {
        ...
        const { email, name, phone, address, items, subtotal, shipping_cost, total, payment_method, discount, coupon_code, shipping_rate } = body;
        ...
        const method = payment_method ?? 'wompi';
        // Validar pasarela via factory (lanza si está inactiva o faltan credenciales)
        let gateway;
        try {
            gateway = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$providers$2f$payment$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getPaymentGateway"])(method, paymentConfig);
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0lxgcnw._.js.map