...
"[project]/apps/web/src/app/api/checkout/gateways/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const GATEWAY_META = {
    ...
    mercadopago: {
        label: 'MercadoPago',
        desc: 'Tarjeta, efectivo, Nequi, Daviplata'
    },
    tucompra: {
        label: 'Tu Compra',
        desc: 'Tarjeta, efectivo, Nequi, PSE'
    },
    bold: {
        label: 'Bold',
        desc: 'Tarjeta, PSE, Nequi, Botón Bancolombia'
    }
};
async function GET() {
    try {
        const config = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$queries$2f$payment$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPaymentConfig"])();
        if (!config) throw new Error('No payment config');
        const names = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$providers$2f$payment$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getActiveGateways"])(config);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1kf9r6z._.js.map