...
# Stack Auth — proyecto ADMIN (Teams = tenants). Solo para APROVISIONAR (HU-209):
# crear el Team + invitar al dueño al crear un tenant. Si faltan, el aprovisionamiento
# es PARCIAL (crea el tenant + subdominio; el Team se adjunta luego).
NEXT_PUBLIC_ADMIN_HEXCLAVE_PROJECT_ID=proj_...
NEXT_PUBLIC_ADMIN_HEXCLAVE_PUBLISHABLE_CLIENT_KEY=pck_...
ADMIN_HEXCLAVE_SECRET_SERVER_KEY=ssk_...
```
